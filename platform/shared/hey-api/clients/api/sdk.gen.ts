 ...
 */
export const promoteChatAttachmentToKnowledgeFile = <ThrowOnError extends boolean = false>(options: Options<PromoteChatAttachmentToKnowledgeFileData, ThrowOnError>) => (options.client ?? client).post<PromoteChatAttachmentToKnowledgeFileResponses, PromoteChatAttachmentToKnowledgeFileErrors, ThrowOnError>({
...
/**
 * Get Knowledge Files upload configuration
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 */
export const getKnowledgeFileUploadConfig = <ThrowOnError extends boolean = false>(options?: Options<GetKnowledgeFileUploadConfigData, ThrowOnError>) => (options?.client ?? client).get<GetKnowledgeFileUploadConfigResponses, GetKnowledgeFileUploadConfigErrors, ThrowOnError>({ url: '/api/knowledge-files/config', ...options });
...
/**
 * Upload files into Knowledge Files
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `knowledgeFile:create`: Upload Knowledge Files
 */
export const uploadKnowledgeFiles = <ThrowOnError extends boolean = false>(options: Options<UploadKnowledgeFilesData, ThrowOnError>) => (options.client ?? client).post<UploadKnowledgeFilesResponses, UploadKnowledgeFilesErrors, ThrowOnError>({
...
/**
 * Delete an uploaded Knowledge File and indexed content
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
...
/**
 * Get an uploaded Knowledge File by ID
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `knowledgeFile:read`: View uploaded Knowledge Files
 */
export const getKnowledgeFile = <ThrowOnError extends boolean = false>(options: Options<GetKnowledgeFileData, ThrowOnError>) => (options.client ?? client).get<GetKnowledgeFileResponses, GetKnowledgeFileErrors, ThrowOnError>({ url: '/api/knowledge-files/{fileId}', ...options });

/**
 * Update an uploaded Knowledge File
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 */
export const updateKnowledgeFile = <ThrowOnError extends boolean = false>(options: Options<UpdateKnowledgeFileData, ThrowOnError>) => (options.client ?? client).put<UpdateKnowledgeFileResponses, UpdateKnowledgeFileErrors, ThrowOnError>({
...
/**
 * Stream uploaded Knowledge File bytes by ID
 *
 * Authentication:
 *
 * Required. Use an authenticated browser session or send your Archestra API key in the `Authorization` header.
 ...
 * `knowledgeFile:read`: View uploaded Knowledge Files
 */
export const getKnowledgeFileContent = <ThrowOnError extends boolean = false>(options: Options<GetKnowledgeFileContentData, ThrowOnError>) => (options.client ?? client).get<unknown, GetKnowledgeFileContentErrors, ThrowOnError>({ url: '/api/knowledge-files/{fileId}/content', ...options });
